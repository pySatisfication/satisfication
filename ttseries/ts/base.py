...
from ttseries.exceptions import SerializerError, RedisTimeSeriesError, RepeatedValueError
    ...
    def _timestamp_exist(self, name, array):
        ...
        if exist_length > 0:
            ...
            if duplicated.size > 0:
                raise RepeatedValueError("add duplicated timestamp into redis -> timestamp:")
